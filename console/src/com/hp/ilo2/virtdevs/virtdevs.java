...
public class virtdevs extends JPanel implements Runnable {
    ...
    public void init() {
        ...
        String rcInfo1 = this.ParentApp.getParameter("RCINFO1");
        this.key = (rcInfo1 != null) ? rcInfo1.getBytes() : new byte[0];
        if (this.ParentApp.optional_features.contains("ENCRYPT_VMKEY") && this.ParentApp.enc_key != null && !this.ParentApp.enc_key.isEmpty()) {
