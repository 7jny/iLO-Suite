...
public class telnet extends JPanel implements Runnable, MouseListener, FocusListener, KeyListener {
    ...
    public synchronized void connect(String var1, String var2, int var3, int var4, int var5, remcons var6) {
        ...
        if (this.connected == 0) {
            ...
            String rcInfo1 = var6.ParentApp.getParameter("RCINFO1");
            this.sessionKey = (rcInfo1 != null) ? rcInfo1.getBytes() : new byte[0];
        ...
        while (var3 != 4) {
            ...
            switch (var3) {
                case 0:
                    ...
                    var4[1] = (byte) ((var1 & '\uff00') >>> 8);
                    if (this.remconsObj.ParentApp.optional_features.contains("ENCRYPT_KEY") && this.remconsObj.ParentApp.enc_key != null && !this.remconsObj.ParentApp.enc_key.isEmpty()) {
